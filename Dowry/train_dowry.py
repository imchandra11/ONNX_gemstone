...
def train_model(args):
    ...
    train_ds = DowryDataset(X_train, y_train)
    val_ds = DowryDataset(X_val, y_val)
    ...
    torch.onnx.export(
        ...
        output_names=["dowry_amount_lakhs"],
        dynamic_axes={"features": {0: "batch"}, "dowry_amount_lakhs": {0: "batch"}},
        opset_version=17,
    )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train dowry amount regressor.")
    parser.add_argument("--csv", type=str, default="dowry_dataset.csv")
